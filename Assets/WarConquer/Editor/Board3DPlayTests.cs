    ...
    public static class Board3DPlayTests
    {
        ...
        static void Run()
        {
            try
            {
                ...
                Spawn(g,0,"hongo-explorador",Biome.Forest);Spawn(g,1,"obelisco-solar",Biome.Desert);
                Spawn(g,2,"jardin-micelial",Biome.Forest);Spawn(g,3,"nomada-de-arena",Biome.Desert);
